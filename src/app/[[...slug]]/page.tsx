...
import { Dashboard, StudentsPage, StudentPage, AssessmentPage, IndicatorsPage, SkillsPage, ObjectivesPage, PeiPage, SummaryPage } from "@/components/pages";
import { ActivityBankPage, ActivityDetailPage } from "@/components/activity-pages";
